...
client: bin/cql-utils bin/cql bin/cql-adapter bin/cql-mysql-adapter bin/cql-faucet bin/cql-explorer
...
.PHONY: status start stop logs push push_testnet clean \
	...
	bin/cql bin/cql-adapter bin/cql-mysql-adapter bin/cql-faucet bin/cql-explorer
